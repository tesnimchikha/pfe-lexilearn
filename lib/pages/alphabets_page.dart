...
class _AlphabetsPageState extends State<AlphabetsPage> {
  ...
  final Map<String, List<DraggableItem>> letterItems = {
    'A': [
      DraggableItem('Apple', 'assets/images/alphabets/apple.png', true, 'assets/audio/a.mp3'),
      DraggableItem('Ant', 'assets/images/alphabets/ant.png', true, 'assets/audio/a.mp3'),
      DraggableItem('Ball', 'assets/images/alphabets/ball.png', false, ''),
      DraggableItem('Car', 'assets/images/alphabets/car.png', false, ''),
    ],
    'B': [
      DraggableItem('Ball', 'assets/images/alphabets/ball.png', true, 'assets/audio/b.mp3'),
      DraggableItem('Banana', 'assets/images/alphabets/banana.png', true, 'assets/audio/b.mp3'),
      DraggableItem('Apple', 'assets/images/alphabets/apple.png', false, ''),
      DraggableItem('Cat', 'assets/images/alphabets/cat.png', false, ''),
    ],
    'C': [
      DraggableItem('Cat', 'assets/images/alphabets/cat.png', true, 'assets/audio/c.mp3'),
      DraggableItem('Car', 'assets/images/alphabets/car.png', true, 'assets/audio/c.mp3'),
      DraggableItem('Ball', 'assets/images/alphabets/ball.png', false, ''),
      DraggableItem('Dog', 'assets/images/alphabets/dog.png', false, ''),
    ],
    'D': [
      DraggableItem('Dog', 'assets/images/alphabets/dog.png', true, 'assets/audio/d.mp3'),
      DraggableItem('Duck', 'assets/images/alphabets/duck.png', true, 'assets/audio/d.mp3'),
      DraggableItem('Cat', 'assets/images/alphabets/cat.png', false, ''),
      DraggableItem('Egg', 'assets/images/alphabets/egg.png', false, ''),
    ],
    'E': [
      DraggableItem('Egg', 'assets/images/alphabets/egg.png', true, 'assets/audio/e.mp3'),
      DraggableItem('Elephant', 'assets/images/alphabets/elephant.png', true, 'assets/audio/e.mp3'),
      DraggableItem('Dog', 'assets/images/alphabets/dog.png', false, ''),
      DraggableItem('Fish', 'assets/images/alphabets/fish.png', false, ''),
    ],
    'F': [
      DraggableItem('Fish', 'assets/images/alphabets/fish.png', true, 'assets/audio/f.mp3'),
      DraggableItem('Frog', 'assets/images/alphabets/frog.png', true, 'assets/audio/f.mp3'),
      DraggableItem('Egg', 'assets/images/alphabets/egg.png', false, ''),
      DraggableItem('Goat', 'assets/images/alphabets/goat.png', false, ''),
    ],
    'G': [
      DraggableItem('Goat', 'assets/images/alphabets/goat.png', true, 'assets/audio/g.mp3'),
      DraggableItem('Grapes', 'assets/images/alphabets/grapes.png', true, 'assets/audio/g.mp3'),
      DraggableItem('Fish', 'assets/images/alphabets/fish.png', false, ''),
      DraggableItem('Hat', 'assets/images/alphabets/hat.png', false, ''),
    ],
    'H': [
      DraggableItem('Hat', 'assets/images/alphabets/hat.png', true, 'assets/audio/h.mp3'),
      DraggableItem('Horse', 'assets/images/alphabets/horse.png', true, 'assets/audio/h.mp3'),
      DraggableItem('Grapes', 'assets/images/alphabets/grapes.png', false, ''),
      DraggableItem('Ice', 'assets/images/alphabets/ice.png', false, ''),
    ],
    'I': [
      DraggableItem('Ice', 'assets/images/alphabets/ice.png', true, 'assets/audio/i.mp3'),
      DraggableItem('Igloo', 'assets/images/alphabets/igloo.png', true, 'assets/audio/i.mp3'),
      DraggableItem('Hat', 'assets/images/alphabets/hat.png', false, ''),
      DraggableItem('Jam', 'assets/images/alphabets/jam.png', false, ''),
    ],
    'J': [
      DraggableItem('Jam', 'assets/images/alphabets/jam.png', true, 'assets/audio/j.mp3'),
      DraggableItem('Juice', 'assets/images/alphabets/juice.png', true, 'assets/audio/j.mp3'),
      DraggableItem('Ice', 'assets/images/alphabets/ice.png', false, ''),
      DraggableItem('Kite', 'assets/images/alphabets/kite.png', false, ''),
    ],
    'K': [
      DraggableItem('Kite', 'assets/images/alphabets/kite.png', true, 'assets/audio/k.mp3'),
      DraggableItem('Key', 'assets/images/alphabets/key.png', true, 'assets/audio/k.mp3'),
      DraggableItem('Jam', 'assets/images/alphabets/jam.png', false, ''),
      DraggableItem('Leaf', 'assets/images/alphabets/leaf.png', false, ''),
    ],
    'L': [
      DraggableItem('Leaf', 'assets/images/alphabets/leaf.png', true, 'assets/audio/l.mp3'),
      DraggableItem('Lion', 'assets/images/alphabets/lion.png', true, 'assets/audio/l.mp3'),
      DraggableItem('Kite', 'assets/images/alphabets/kite.png', false, ''),
      DraggableItem('Monkey', 'assets/images/alphabets/monkey.png', false, ''),
    ],
    'M': [
      DraggableItem('Monkey', 'assets/images/alphabets/monkey.png', true, 'assets/audio/m.mp3'),
      DraggableItem('Moon', 'assets/images/alphabets/moon.png', true, 'assets/audio/m.mp3'),
      DraggableItem('Leaf', 'assets/images/alphabets/leaf.png', false, ''),
      DraggableItem('Nest', 'assets/images/alphabets/nest.png', false, ''),
    ],
    'N': [
      DraggableItem('Nest', 'assets/images/alphabets/nest.png', true, 'assets/audio/n.mp3'),
      DraggableItem('Nut', 'assets/images/alphabets/nut.png', true, 'assets/audio/n.mp3'),
      DraggableItem('Monkey', 'assets/images/alphabets/monkey.png', false, ''),
      DraggableItem('Orange', 'assets/images/alphabets/orange.png', false, ''),
    ],
    'O': [
      DraggableItem('Orange', 'assets/images/alphabets/orange.png', true, 'assets/audio/o.mp3'),
      DraggableItem('Owl', 'assets/images/alphabets/owl.png', true, 'assets/audio/o.mp3'),
      DraggableItem('Nest', 'assets/images/alphabets/nest.png', false, ''),
      DraggableItem('Pizza', 'assets/images/alphabets/pizza.png', false, ''),
    ],
    'P': [
      DraggableItem('Pizza', 'assets/images/alphabets/pizza.png', true, 'assets/audio/p.mp3'),
      DraggableItem('Pen', 'assets/images/alphabets/pen.png', true, 'assets/audio/p.mp3'),
      DraggableItem('Orange', 'assets/images/alphabets/orange.png', false, ''),
      DraggableItem('Queen', 'assets/images/alphabets/queen.png', false, ''),
    ],
    'Q': [
      DraggableItem('Queen', 'assets/images/alphabets/queen.png', true, 'assets/audio/q.mp3'),
      DraggableItem('Quilt', 'assets/images/alphabets/quilt.png', true, 'assets/audio/q.mp3'),
      DraggableItem('Pen', 'assets/images/alphabets/pen.png', false, ''),
      DraggableItem('Rabbit', 'assets/images/alphabets/rabbit.png', false, ''),
    ],
    'R': [
      DraggableItem('Rabbit', 'assets/images/alphabets/rabbit.png', true, 'assets/audio/r.mp3'),
      DraggableItem('Ring', 'assets/images/alphabets/ring.png', true, 'assets/audio/r.mp3'),
      DraggableItem('Queen', 'assets/images/alphabets/queen.png', false, ''),
      DraggableItem('Sun', 'assets/images/alphabets/sun.png', false, ''),
    ],
    'S': [
      DraggableItem('Sun', 'assets/images/alphabets/sun.png', true, 'assets/audio/s.mp3'),
      DraggableItem('Star', 'assets/images/alphabets/star.png', true, 'assets/audio/s.mp3'),
      DraggableItem('Rabbit', 'assets/images/alphabets/rabbit.png', false, ''),
      DraggableItem('Tiger', 'assets/images/alphabets/tiger.png', false, ''),
    ],
    'T': [
      DraggableItem('Tiger', 'assets/images/alphabets/tiger.png', true, 'assets/audio/t.mp3'),
      DraggableItem('Tree', 'assets/images/alphabets/tree.png', true, 'assets/audio/t.mp3'),
      DraggableItem('Sun', 'assets/images/alphabets/sun.png', false, ''),
      DraggableItem('Umbrella', 'assets/images/alphabets/umbrella.png', false, ''),
    ],
    'U': [
      DraggableItem('Umbrella', 'assets/images/alphabets/umbrella.png', true, 'assets/audio/u.mp3'),
      DraggableItem('Unicorn', 'assets/images/alphabets/unicorn.png', true, 'assets/audio/u.mp3'),
      DraggableItem('Tree', 'assets/images/alphabets/tree.png', false, ''),
      DraggableItem('Violin', 'assets/images/alphabets/violin.png', false, ''),
    ],
    'V': [
      DraggableItem('Violin', 'assets/images/alphabets/violin.png', true, 'assets/audio/v.mp3'),
      DraggableItem('Van', 'assets/images/alphabets/van.png', true, 'assets/audio/v.mp3'),
      DraggableItem('Umbrella', 'assets/images/alphabets/umbrella.png', false, ''),
      DraggableItem('Whale', 'assets/images/alphabets/whale.png', false, ''),
    ],
    'W': [
      DraggableItem('Whale', 'assets/images/alphabets/whale.png', true, 'assets/audio/w.mp3'),
      DraggableItem('Watch', 'assets/images/alphabets/watch.png', true, 'assets/audio/w.mp3'),
      DraggableItem('Violin', 'assets/images/alphabets/violin.png', false, ''),
      DraggableItem('Xylophone', 'assets/images/alphabets/xylophone.png', false, ''),
    ],
    'X': [
      DraggableItem('Xylophone', 'assets/images/alphabets/xylophone.png', true, 'assets/audio/x.mp3'),
      DraggableItem('X-ray', 'assets/images/alphabets/xray.png', true, 'assets/audio/x.mp3'),
      DraggableItem('Watch', 'assets/images/alphabets/watch.png', false, ''),
      DraggableItem('Yak', 'assets/images/alphabets/yak.png', false, ''),
    ],
    'Y': [
      DraggableItem('Yak', 'assets/images/alphabets/yak.png', true, 'assets/audio/y.mp3'),
      DraggableItem('Yarn', 'assets/images/alphabets/yarn.png', true, 'assets/audio/y.mp3'),
      DraggableItem('Xylophone', 'assets/images/alphabets/xylophone.png', false, ''),
      DraggableItem('Zebra', 'assets/images/alphabets/zebra.png', false, ''),
    ],
    'Z': [
      DraggableItem('Zebra', 'assets/images/alphabets/zebra.png', true, 'assets/audio/z.mp3'),
      DraggableItem('Zoo', 'assets/images/alphabets/zoo.png', true, 'assets/audio/z.mp3'),
  ...
  void _playCorrectSound() => _audioPlayer.play(AssetSource('assets/audio/correct.mp3'));
  void _playErrorSound() => _audioPlayer.play(AssetSource('assets/audio/error.mp3'));
